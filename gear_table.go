...
//
// The seed is hased using SHAK3, and the constants are set to the first
// 2 KiB of data generated by the XOF, interpreted as a sequence of
// little-endian integers.
func NewSeededGearTable(seed []byte) *GearTable {
	seedHash := sha3.NewSHAKE128()
